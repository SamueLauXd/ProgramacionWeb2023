            ...
            <main className="grid grid-cols-2 px-12">
                <section className="flex flex-col gap-8">
                    ...
                    <ul className="flex flex-col gap-12">
                        <a href="#"><li className="flex gap-2 items-center text-white"><img src="./src/assets/icons/mail-icon.svg" alt="Email icon" aria-hidden="true" /> contact@uxperience.com</li></a>
                        <a href="#"><li className="flex gap-2 items-center text-white"><img src="./src/assets/icons/tel-icon.svg" alt="Phone icon" aria-hidden="true" /> +57 3216549874</li></a>
                        <a href="#"><li className="flex gap-2 items-center text-white"><img src="./src/assets/icons/location-icon.svg" alt="Location icon" aria-hidden="true" /> Universidad Icesi</li></a>
                    </ul>
                </section>
                <form className="flex flex-col justify-between bg-white rounded-lg py-6 px-8" id="contact-form">
                    ...
                    <h6>I’m interested in...</h6>
                        <ul className=" flex flex-wrap w-5/6 justify-start gap-4 ">
                            <li className="w-min">
                                <input type="checkbox" id="ui-ux-option" value="ui-ux" className="hidden peer" required="" />
                                <label htmlFor="ui-ux-option" className="inline-flex items-center opacity-50 justify-between w-max px-5 py-2.5 text-gray-500 bg-white border-2 border-gray-200 rounded-2xl cursor-pointer dark:hover:text-aquamarine-200 dark:border-gray-700 peer-checked:border-aquamarine-200 peer-checked:opacity-100 peer-checked:bg-aquamarine-200 hover:text-gray-600 dark:peer-checked:text-white peer-checked:text-white hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                                    UI/UX Design
                                </label>
                            </li>
                            <li className="w-min">
                                <input type="checkbox" id="web-option" value="web-design" className="hidden peer" />
                                <label htmlFor="web-option" className="inline-flex items-center opacity-50 justify-between w-max px-5 py-2.5 text-gray-500 bg-white border-2 border-gray-200 rounded-2xl cursor-pointer dark:hover:text-aquamarine-200 dark:border-gray-700 peer-checked:border-aquamarine-200 peer-checked:opacity-100 peer-checked:bg-aquamarine-200 hover:text-gray-600 dark:peer-checked:text-white peer-checked:text-white hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                                    Web Design
                                </label>
                            </li>
                            <li className="w-min">
                                <input type="checkbox" id="brand-option" value="brand-marketing" className="hidden peer" />
                                <label htmlFor="brand-option" className="inline-flex items-center opacity-50 justify-between w-max px-5 py-2.5 text-gray-500 bg-white border-2 border-gray-200 rounded-2xl cursor-pointer dark:hover:text-aquamarine-200 dark:border-gray-700 peer-checked:border-aquamarine-200 peer-checked:opacity-100 peer-checked:bg-aquamarine-200 hover:text-gray-600 dark:peer-checked:text-white peer-checked:text-white hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                                    Brand and Marketing
                                </label>
                            </li>
                        </ul>
